...
namespace Capital.Entity
{
    public class Data
    {
        ...
        /// <summary>
        /// для расчета абсолютной просадки в деньгах
        /// </summary>
        private void CalculateDrowDown()
        {
            if (_max < ResultDepo)
            {
                _max = ResultDepo;
        ...
        /// <summary>
        /// для расчета относительной просадки в процентах
        /// </summary>
        private void CalculatePercentDrowDown()
        {
